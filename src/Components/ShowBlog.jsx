...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
    <h2 data-aos="zoom-out" className="text-2xl font-bold md:text-4xl md:leading-tight text-[#FF0B55]">Recent Blog</h2>
    <p data-aos="zoom-out" className="mt-1 text-gray-200 dark:text-neutral-400">Stay in the know with insights from industry experts.</p>
  </div>
  ...
  <div  className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <a data-aos="zoom-out-right" className="group flex flex-col focus:outline-none" href="#">
      ...
      <div className="mt-7">
        <h3 className="text-xl font-semibold text-[#CF0F47] group-hover:text-gray-600 dark:text-neutral-300 dark:group-hover:text-white">
        Finding Your Perfect Rental
        </h3>
        <p className="mt-3 text-gray-500 dark:text-neutral-200">
        Looking for a rental property can be overwhelming, especially with so many options available online.
        </p>
        <p className="mt-5 inline-flex items-center gap-x-1 text-sm text-[#FF0B55] decoration-2 group-hover:underline group-focus:underline font-medium dark:text-blue-500">
          Read more
    ...
    <a data-aos="zoom-out-left" className="group flex flex-col focus:outline-none" href="#">
      ...
      <div className="mt-7">
        ...
        <p className="mt-5 inline-flex items-center gap-x-1 text-sm text-[#FF0B55] decoration-2 group-hover:underline group-focus:underline font-medium dark:[#FF0B55]">
          Read more
          <svg className="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
        </p>
      </div>
